...
export default function GalleryTab({
  ...
  if (needsAuth) {
    return (
      <div className="flex flex-col items-center justify-center py-16 px-4 text-center max-w-xl mx-auto" id="gallery-auth-needed-container">
        ...
        <button
          onClick={onLogin}
          className="w-full flex items-center justify-center gap-3 bg-teal-600 hover:bg-teal-700 text-white font-extrabold px-6 py-4 rounded-2xl shadow-lg shadow-teal-600/15 active:scale-95 transition-all text-base"
